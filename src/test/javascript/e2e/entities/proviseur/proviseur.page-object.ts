...
export class ProviseurComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-proviseur div table .btn-danger'));
  title = element.all(by.css('jhi-proviseur div h2#page-heading span')).first();
...
export class ProviseurUpdatePage {
  pageTitle = element(by.id('jhi-proviseur-heading'));
...
export class ProviseurDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-proviseur-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-proviseur'));
