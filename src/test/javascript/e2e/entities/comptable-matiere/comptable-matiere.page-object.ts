...
export class ComptableMatiereComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-comptable-matiere div table .btn-danger'));
  title = element.all(by.css('jhi-comptable-matiere div h2#page-heading span')).first();
...
export class ComptableMatiereUpdatePage {
  pageTitle = element(by.id('jhi-comptable-matiere-heading'));
...
export class ComptableMatiereDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-comptableMatiere-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-comptableMatiere'));
