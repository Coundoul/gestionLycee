...
export class DirecteurEtudeComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-directeur-etude div table .btn-danger'));
  title = element.all(by.css('jhi-directeur-etude div h2#page-heading span')).first();
...
export class DirecteurEtudeUpdatePage {
  pageTitle = element(by.id('jhi-directeur-etude-heading'));
...
export class DirecteurEtudeDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-directeurEtude-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-directeurEtude'));
