...
describe('Component Tests', () => {
  describe('PersonnelAdministratif Management Component', () => {
    let comp: PersonnelAdministratifComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PersonnelAdministratifComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.personnelAdministratifs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
