...
describe('Component Tests', () => {
  describe('Difficulte Management Component', () => {
    let comp: DifficulteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DifficulteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.difficultes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
