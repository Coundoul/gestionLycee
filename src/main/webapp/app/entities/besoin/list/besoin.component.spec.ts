...
describe('Component Tests', () => {
  describe('Besoin Management Component', () => {
    let comp: BesoinComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BesoinComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.besoins?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
