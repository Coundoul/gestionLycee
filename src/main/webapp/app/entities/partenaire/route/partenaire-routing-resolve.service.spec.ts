...
describe('Service Tests', () => {
  describe('Partenaire routing resolve service', () => {
    ...
    let resultPartenaire: IPartenaire | undefined;
    ...
    describe('resolve', () => {
      ...
      it('should return new IPartenaire if id is not provided', () => {
        // GIVEN
        ...
        expect(resultPartenaire).toEqual(new Partenaire());
      });

      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Partenaire })));
        mockActivatedRouteSnapshot.params = { id: 123 };
